...
const DATA = [
  {
    id: "1",
    title: "Motivational",
    imageUrl: require("@/assets/images/motivation.png"),
  },
  {
    id: "2",
    title: "Happy",
    imageUrl: require("@/assets/images/talent.png"),
  },
  {
    id: "3",
    title: "Romantic",
    imageUrl: require("@/assets/images/raise-hand.png"),
  },
  {
    id: "4",
    title: "Chill",
...
interface OnboardingItemProps {
  ...
  data: { id: string; title: string; imageUrl?: any }[];
  selectedTitle: string;
  selectedTitleStep2: string;
  stepNumber: string;
  selectedStep: string;
  page1?: boolean;
  page3?: boolean;
...
function Onboarding1() {
  ...
  const handlePress = (id: string, title: string, index: number) => {
    setSelectedId(id);
    if (index === 0) {
  ...
  const flatRef = createRef<FlatList<any>>();
