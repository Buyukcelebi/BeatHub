    ...
    <TouchableOpacity
      ...
      <View
        ...
        <View style={style.subsButtonWrapper}>
          <View style={[style.iconDotWrapper, !isSelected && { borderColor: '#44505f' }]}>
            {isSelected && <View style={style.iconDot} />}
          </View>
          <View style={style.subsTextWrapper}>
            <Text style={[style.text, style.subscriptionButtonText, fontSize && { fontSize }]}>
          ...
          {price && (
            <View style={style.priceWrapper}>
              <Text
                ...
                {isLoading ? <ActivityIndicator /> : `${t(price)}/${period}`}
              </Text>
            </View>
          )}

          {discountText && (
            <View style={[style.discountItem, discountColor && { backgroundColor: discountColor }]}>
